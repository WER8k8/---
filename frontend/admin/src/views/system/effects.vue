  ...
  <YdPage title="自定义特效组件" subtitle="配置页面交互动画和视觉特效" surface="elevated">
    <a-row :gutter="16">
      ...
      <a-col :span="12">
        <a-card title="动画预览">
          <div
            class="relative h-48 bg-gradient-to-br from-indigo-50 via-white to-purple-50 rounded-xl overflow-hidden"
          >
            <!-- 背景装饰动画 -->
            ...
            >
              ...
              >
                <div
                  class="w-24 h-24 bg-gradient-to-br from-primary-500 to-indigo-600 rounded-2xl shadow-xl flex items-center justify-center transform hover:scale-105 transition-transform cursor-pointer"
                >
            ...
            >
              <div
                class="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mb-3 animate-bounce"
              >
            ...
            <transition name="fade">
              ...
              >
                <BulbOutlined class="animate-ping" />
                {{ tipText }}
              </div>
            </transition>
          </div>
        ...
        <a-row :gutter="16">
          <a-col :span="12">
            <a-form-item label="全局动画开关">
              <a-switch v-model:checked="effectSettings.globalEnabled" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="启用悬停效果">
              <a-switch v-model:checked="effectSettings.hoverEffects" />
            </a-form-item>
          </a-col>
        </a-row>
      ...
      <a-row :gutter="16">
        <a-col :span="8">
          <a-form-item label="启用粒子效果">
            <a-switch v-model:checked="particleSettings.enabled" />
          </a-form-item>
        </a-col>
        <a-col :span="8">
...
import { BulbOutlined, PictureOutlined, ZoomInOutlined, BarChartOutlined } from '@ant-design/icons-vue';
import {
  Card as ACard,
  Button as AButton,
  Form as AForm,
