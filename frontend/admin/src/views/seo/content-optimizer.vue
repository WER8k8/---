        ...
        <a-row :gutter="16">
          <a-col :span="12">
            <a-form-item
              ...
              :required="true"
            >
              <a-select v-model:value="form.optimization_type" style="width: 100%">
          ...
          <a-col :span="12">
            <a-form-item label="AI 场景">
              <a-tag color="green">文章场景</a-tag>
              <span class="text-gray-500 text-sm ml-2">{{ articleModel || '加载中…' }}</span>
              <a-button type="link" size="small" href="/admin/ai-center/scenario-models">切换</a-button>
            </a-form-item>
          </a-col>
        </a-row>
...
onMounted(async () => {
  try {
    ...
    articleModel.value = data?.mappings?.article || '';
  } catch {
    articleModel.value = '';
  }
});
