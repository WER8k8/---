<template>
  <div class="cases-page">
    <!-- Hero Section -->
    <section
      class="cases-hero bg-gradient-to-br from-accent/5 via-surface to-primary/5 py-16 md:py-24"
    >
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div
            v-for="i in 6"
            :key="i"
            class="case-card-skeleton animate-pulse"
          >
            <div class="bg-gray-200 h-56 rounded-t-2xl" />
            <div class="p-6">
        ...
        >
          ...
          >
            ...
            >
              <!-- Case Image -->
              <div
                class="case-image relative h-56 overflow-hidden bg-gradient-to-br from-accent/5 to-primary/5"
              >
                <img
              ...
              <div class="p-6">
                ...
                <p class="text-sm text-text-secondary line-clamp-2 mb-4">
                  {{ caseItem.description || t('cases.clickViewDetails') }}
                </p>
                ...
                <div class="flex items-center justify-between text-sm text-text-secondary">
                  <div class="flex items-center">
                    ...
                    {{ caseItem.view_count }} {{ t('cases.viewCount') }}
                  </div>
                  <span class="text-accent font-medium group-hover:underline"> {{ t('cases.viewDetailsLink') }} </span>
                </div>
              </div>
            </NuxtLink>
          </AnimatedSection>
    ...
    <!-- CTA Section -->
    <section
      class="cta-section py-16 bg-gradient-to-br from-accent/5 via-surface-elevated to-primary/5"
    >
        ...
        >
          ...
          <div class="flex flex-wrap justify-center gap-4">
            ...
            <a
              ...
              class="btn-outline"
            > {{ t('cases.ctaPhonePrefix') }}{{ contactPhone }} </a>
          </div>
        </AnimatedSection>
      </div>
    </section>
...
const filters = computed(() => [
  { id: 'all', name: t('cases.filterAll') },
  { id: 'published', name: t('cases.filterPublished') },
  { id: 'ongoing', name: t('cases.filterOngoing') },
]);
...
useHead({
  title: computed(() => t('cases.seo.title')),
  meta: [
    {
      name: 'description',
      content: computed(() => t('cases.seo.desc')),
    },
    { name: 'keywords', content: computed(() => t('cases.seo.keywords')) },
  ],
});
</script>
