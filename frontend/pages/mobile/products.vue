  ...
  <div class="min-h-screen bg-gray-50 pb-safe-bottom">
    ...
    <div class="pt-16 px-4 pb-2">
      <h1 class="text-xl font-bold text-gray-900">
        {{ $t('mobile.products.pageTitle') }}
      </h1>
      <p class="text-sm text-gray-500 mt-1">
        {{ $t('mobile.products.pageSubtitle') }}
      </p>
    </div>
      ...
      <div class="px-4 py-4">
        ...
        >
          ...
          <h3 class="text-base font-semibold text-gray-700 mb-1">
            {{ $t('mobile.products.noProducts') }}
          </h3>
          <p class="text-sm text-gray-400">
            {{ $t('mobile.products.noProductsDesc') }}
          </p>
        </div>
            ...
            <div class="p-3">
              ...
              <div class="flex flex-wrap gap-1">
                <span
                  ...
                  class="px-1.5 py-0.5 bg-blue-50 text-blue-600 text-[10px] rounded-lg"
                >{{ product.density }}</span>
                <span
                  v-if="product.strength"
                  class="px-1.5 py-0.5 bg-purple-50 text-purple-600 text-[10px] rounded-lg"
