...
<template>
  <div class="min-h-screen bg-gray-50 pb-safe-bottom">
    ...
    <div
      v-if="loading"
      class="px-4 py-4 grid grid-cols-2 gap-3"
    >
      <div
        v-for="i in 4"
        :key="i"
        class="bg-white rounded-2xl p-3 animate-pulse"
      >
    ...
    >
      ...
      <h3 class="text-base font-medium text-gray-900 mb-2">
        {{ t('mobile.favorites.noFavorites') }}
      </h3>
      <p class="text-sm text-gray-500 mb-6">
        {{ t('mobile.favorites.noFavoritesDesc') }}
      </p>
      <NuxtLink
        to="/mobile/products"
    ...
    <div
      v-else
      class="px-4 py-2 grid grid-cols-2 gap-3 pb-20"
    >
      <div
