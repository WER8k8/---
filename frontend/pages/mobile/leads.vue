  ...
  <div class="min-h-screen bg-gray-50 pb-safe-bottom">
    ...
    >
      ...
      <h3 class="text-base font-medium text-gray-900 mb-2">
        {{ $t('mobile.leads.noLeads') }}
      </h3>
      <p class="text-sm text-gray-500 mb-6">
        {{ $t('mobile.leads.noLeadsDesc') }}
      </p>
      <button
        ...
        <div class="w-full max-w-lg bg-white rounded-t-2xl p-6 max-h-[80vh] overflow-y-auto">
          ...
          >
            ...
            <div class="flex gap-3 pt-4">
              <button
                type="button"
                class="flex-1 mobile-btn-outline py-3 rounded-xl font-medium"
              ...
              <button
                type="submit"
                class="flex-1 mobile-btn-primary py-3 rounded-xl font-medium"
              >
                {{ $t('common.save') }}
              </button>
            </div>
