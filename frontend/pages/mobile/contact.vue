    ...
    <div class="pt-16">
      ...
      <div class="bg-gradient-to-br from-blue-600 to-blue-700 px-4 py-8 text-white">
        <div class="text-center mb-6">
          <h1 class="text-2xl font-bold mb-2">
            {{ $t('mobile.contact.pageTitle') }}
          </h1>
          <p class="text-sm text-blue-100">
            {{ $t('mobile.contact.heroSubtitle') }}
          </p>
        </div>
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              <p class="text-sm font-semibold">
                {{ $t('mobile.contact.wechatService') }}
              </p>
              <p class="text-xs text-blue-100">
                {{ $t('mobile.contact.wechatId') }}
              </p>
            </div>
          </div>
      ...
      <div class="px-4 py-5 space-y-3">
        <div
          ...
          :key="item.label"
          class="flex items-center gap-3 bg-white rounded-xl p-4 shadow-sm border border-gray-100"
        >
      ...
      <div class="px-4 pb-6">
        ...
        >
          ...
          <p
            v-if="submitSuccess"
            class="text-green-600 text-center font-medium mt-4 text-sm flex items-center justify-center gap-1"
          >
            <svg
              class="w-4 h-4"
              fill="none"
          ...
          <p
            v-if="submitError"
            class="text-red-500 text-center font-medium mt-4 text-sm"
          >
            {{ submitError }}
          </p>
        </form>
