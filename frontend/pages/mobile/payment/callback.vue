...
<template>
  <div class="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4">
    ...
    <div
      ...
      class="text-center max-w-sm w-full"
    >
      ...
      <h1 class="text-2xl font-bold text-gray-900 mb-2">
        {{ $t('mobile.payment.successTitle') }}
      </h1>
      <p class="text-base text-gray-600 mb-8">
        {{ $t('mobile.payment.successDesc') }}
      </p>
    ...
    >
      ...
      <h1 class="text-2xl font-bold text-gray-900 mb-2">
        {{ $t('mobile.payment.failureTitle') }}
      </h1>
      <p class="text-base text-gray-600 mb-8">
        {{ $t('mobile.payment.failureDesc') }}
      </p>
    ...
    >
      ...
      <h1 class="text-2xl font-bold text-gray-900 mb-2">
        {{ $t('mobile.payment.pendingTitle') }}
      </h1>
      <p class="text-base text-gray-600 mb-8">
        {{ $t('mobile.payment.pendingDesc') }}
      </p>
