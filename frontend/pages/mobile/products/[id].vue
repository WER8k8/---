  ...
  <div class="min-h-screen bg-gray-50 pb-safe-bottom">
    ...
    <MobileNavbar safe-area-top :blur="true">
      <div class="flex items-center h-14">
        ...
        <h1 class="ml-2 text-base font-semibold text-gray-900 truncate">{{ product?.name || $t('mobile.product.detail') }}</h1>
      </div>
    </MobileNavbar>
    ...
    <div v-if="pending" class="px-4 py-6">
      <div class="animate-pulse">
        <div class="w-full h-64 bg-gray-200 rounded-2xl mb-4"></div>
    ...
    <div v-else-if="error" class="px-4 py-20 text-center">
      <div class="text-red-500 text-base font-medium mb-4">{{ $t('mobile.product.loadError') }}</div>
    ...
    <div v-else-if="product" class="pb-20">
      ...
      <div class="relative bg-white">
        ...
        <!-- Image Indicators -->
        <div v-if="product.images && product.images.length > 1" class="flex justify-center gap-1.5 py-3">
          <button
      ...
      <div class="px-4 py-5 bg-white mt-2">
        ...
        <div v-if="product.specs" class="border-t border-gray-100 pt-4 mt-4">
          <h3 class="text-sm font-semibold text-gray-900 mb-3">{{ $t('mobile.product.specs') }}</h3>
          <div class="space-y-2">
