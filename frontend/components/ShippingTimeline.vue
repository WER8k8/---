    ...
    <div class="space-y-0">
      ...
      <div class="flex gap-4 pb-6 relative">
        <div class="flex flex-col items-center">
          ...
          <div class="w-0.5 flex-1 bg-green-200 mt-2"></div>
        </div>
        <div class="flex-1 pb-2">
          <div class="font-semibold text-gray-800">{{ timeline?.steps?.[0]?.title || t('shipping.step1') }}</div>
          <div class="text-sm text-gray-500 mt-1">{{ timeline?.steps?.[0]?.desc || t('shipping.step1_desc') }}</div>
      ...
      <div class="flex gap-4 pb-6 relative">
        ...
        <div class="flex-1 pb-2">
          <div class="font-semibold text-gray-800">{{ timeline?.steps?.[1]?.title || t('shipping.step2') }}</div>
          <div class="text-sm text-gray-500 mt-1">{{ timeline?.steps?.[1]?.desc || t('shipping.step2_desc') }}</div>
          ...
          <div v-if="timeline?.steps?.[1]?.badge" class="inline-block mt-1 ml-2 px-2 py-0.5 bg-orange-50 text-orange-700 text-xs font-medium rounded">
      ...
      <div class="flex gap-4 pb-6 relative">
        <div class="flex flex-col items-center">
          ...
          <div class="w-0.5 flex-1 bg-purple-200 mt-2"></div>
        </div>
        <div class="flex-1 pb-2">
          <div class="font-semibold text-gray-800">{{ timeline?.steps?.[2]?.title || t('shipping.step3') }}</div>
          <div class="text-sm text-gray-500 mt-1">{{ timeline?.steps?.[2]?.desc || t('shipping.step3_desc') }}</div>
      ...
      <div class="flex gap-4">
        ...
        <div class="flex-1">
          <div class="font-semibold text-gray-800">{{ timeline?.steps?.[3]?.title || t('shipping.step4') }}</div>
          <div class="text-sm text-gray-500 mt-1">{{ timeline?.steps?.[3]?.desc || t('shipping.step4_desc') }}</div>
