...
<template>
  <div class="space-y-6">
    ...
    >
      ...
      >
        <li
          ...
          :class="
            issue.severity === 'error' ? 'text-red-600 bg-red-50' : 'text-orange-600 bg-orange-50'
          "
        >
          {{ issue.message }}
        </li>
    ...
    >
      ...
      <pre
        class="bg-gray-50 border border-gray-200 rounded-lg p-4 text-sm font-mono whitespace-pre-wrap max-h-96 overflow-y-auto"
      >{{ result.content }}</pre>
    </div>
  </div>
</template>
