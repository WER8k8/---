...
export function useSeo() {
  ...
  async function optimizeContent(req: OptimizeRequest): Promise<OptimizeResponse> {
    return request<OptimizeResponse>('/seo/content-optimizer/optimize', {
      method: 'POST',
      body: req,
    });
  }
  ...
  async function validateContent(
    ...
    return request<ValidateContentResponse>('/seo/content-optimizer/validate-content', {
      method: 'POST',
  ...
  async function extractParams(content: string): Promise<ExtractParamsResponse> {
    return request<ExtractParamsResponse>('/seo/content-optimizer/extract-params', {
      method: 'POST',
      body: { content },
    });
  }
  ...
  async function generateLlmsTxt(req: LlmsGenerateRequest): Promise<LlmsGenerateResponse> {
    return request<LlmsGenerateResponse>('/seo/llms-txt/generate', { method: 'POST', body: req });
  }

  async function validateLlmsTxt(content: string): Promise<LlmsValidateResponse> {
    return request<LlmsValidateResponse>('/seo/llms-txt/validate-llms-txt', {
      method: 'POST',
      body: { content },
    });
  }
  ...
  function getTemplate() {
    return useRequest<LlmsTemplateResponse>('/seo/llms-txt/llms-txt-template');
  }
