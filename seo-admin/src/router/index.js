...
import { redirectToMainAdminLogin } from '@/utils/authBridge';
...
const routes = [
  {
    path: '/login',
    name: 'Login',
    component: () => import('@/pages/LocalLogin.vue'),
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'capability-hub',
        name: 'CapabilityHub',
        component: () => import('@/pages/CapabilityHub.vue'),
        meta: { title: '主站能力导航' },
      },
      {
        path: 'logs',
...
router.beforeEach(async (to, from, next) => {
  ...
  userStore.hydrateFromMainAdminToken();
