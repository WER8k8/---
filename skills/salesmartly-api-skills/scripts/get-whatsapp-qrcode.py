...
API ID: 328937730e0
Endpoint: /api/v2/start-individual-whatsapp-app
Method: GET
...
def main():
    parser = argparse.ArgumentParser(description="获取 WhatsApp 二维码")
    ...
    try:
        ...
        data = client.get("/api/v2/start-individual-whatsapp-app", {"id": args.id})
