...
def upgrade():
    ...
    op.create_index(
        op.f("ix_eeat_authors_id"),
        "eeat_authors",
        ["id"],
        unique=False)
    op.create_index(
        op.f("ix_eeat_authors_is_verified"),
        "eeat_authors",
        ["is_verified"],
        unique=False)
    op.create_index(
        op.f("ix_eeat_authors_name"),
        "eeat_authors",
        ["name"],
        unique=False)
    ...
    op.create_table(
        ...
        sa.Column("id", _uuid_col(), nullable=False),
        sa.Column("author_id", _uuid_col(), nullable=True),
    ...
    op.create_index(
        op.f("ix_eeat_author_certifications_id"),
        "eeat_author_certifications",
        ["id"],
        unique=False)
    op.create_index(
        op.f("ix_eeat_author_certifications_author_id"),
        "eeat_author_certifications",
        ["author_id"],
        unique=False)
    ...
    op.create_index(
        op.f("ix_eeat_article_authors_id"),
        "eeat_article_authors",
        ["id"],
        unique=False)
    op.create_index(
        op.f("ix_eeat_article_authors_article_id"),
        "eeat_article_authors",
        ["article_id"],
        unique=False)
    op.create_index(
        op.f("ix_eeat_article_authors_author_id"),
        "eeat_article_authors",
        ["author_id"],
        unique=False)
    ...
    op.create_index(
        op.f("ix_eeat_scores_id"),
        "eeat_scores",
        ["id"],
        unique=False)
    op.create_index(
        op.f("ix_eeat_scores_content_id"),
        "eeat_scores",
        ["content_id"],
        unique=False)
    op.create_index(
        op.f("ix_eeat_scores_content_type"),
        "eeat_scores",
        ["content_type"],
        unique=False)
    ...
    op.create_index(
        op.f("ix_eeat_trust_signals_id"),
        "eeat_trust_signals",
        ["id"],
        unique=False)
    op.create_index(
        op.f("ix_eeat_trust_signals_content_id"),
        "eeat_trust_signals",
        ["content_id"],
        unique=False)
    op.create_index(
        op.f("ix_eeat_trust_signals_signal_type"),
        "eeat_trust_signals",
        ["signal_type"],
        unique=False)
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_eeat_article_authors_author_id"),
        table_name="eeat_article_authors")
    op.drop_index(
        op.f("ix_eeat_article_authors_article_id"),
        table_name="eeat_article_authors")
    op.drop_index(
    ...
    op.drop_index(
        op.f("ix_eeat_author_certifications_author_id"),
        table_name="eeat_author_certifications")
    op.drop_index(op.f("ix_eeat_author_certifications_id"),
                  table_name="eeat_author_certifications")
