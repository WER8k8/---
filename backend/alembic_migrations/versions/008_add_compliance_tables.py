...
def upgrade():
    ...
    op.create_index(
        op.f("ix_compliance_rules_id"),
        "compliance_rules",
        ["id"],
        unique=False)
    op.create_index(
        op.f("ix_compliance_rules_rule_type"),
        "compliance_rules",
        ["rule_type"],
        unique=False)
    ...
    op.create_index(
        op.f("ix_compliance_scan_results_id"),
        "compliance_scan_results",
        ["id"],
        unique=False)
    op.create_index(
        op.f("ix_compliance_scan_results_content_id"),
        "compliance_scan_results",
        ["content_id"],
        unique=False)
    ...
    op.create_index(
        op.f("ix_compliance_violations_id"),
        "compliance_violations",
        ["id"],
        unique=False)
    op.create_index(
        op.f("ix_compliance_violations_scan_result_id"),
        "compliance_violations",
        ["scan_result_id"],
        unique=False)
    op.create_index(
        op.f("ix_compliance_violations_rule_id"),
        "compliance_violations",
        ["rule_id"],
        unique=False)
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_compliance_violations_scan_result_id"),
        table_name="compliance_violations")
    op.drop_index(op.f("ix_compliance_violations_id"),
                  table_name="compliance_violations")
    op.drop_table("compliance_violations")

    op.drop_index(
        op.f("ix_compliance_scan_results_content_id"),
        table_name="compliance_scan_results")
    op.drop_index(op.f("ix_compliance_scan_results_id"),
                  table_name="compliance_scan_results")
