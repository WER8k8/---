path = 'app/api/v1/routes/gdpr.py'
lines = open(path, encoding='utf-8').read().split('\n')
# replace 1-indexed lines 47..208 inclusive (whole gdpr_delete_data func)
start, end = 47, 208
new_block = '''@router.post("/delete-data")
...
print("gdpr.py updated; new line count:", len(new_lines))
