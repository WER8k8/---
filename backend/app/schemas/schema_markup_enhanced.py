...
class OrganizationSchema(BaseModel):
    ...
    description: str = "专注新型建筑材料研发与生产20年，提供轻集料混凝土、陶粒混凝土、保温砂浆等高品质产品"
    ...
    def to_json_ld(self) -> dict:
        ...
        data = {
            ...
            "publisher": {
                "@type": "Organization",
                "name": self.publisher,
                "logo": {"@type": "ImageObject", "url": self.publisher_logo},
            },
        }
...
class BreadcrumbSchema(BaseModel):
    ...
    def to_json_ld(self) -> dict:
        ...
        for idx, item in enumerate(self.items, 1):
            item_list.append({"@type": "ListItem", "position": idx,
