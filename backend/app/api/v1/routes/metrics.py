...
MEMORY_USAGE = Gauge("memory_usage_bytes", "Memory usage in bytes", ["type"], registry=registry)
DISK_USAGE = Gauge("disk_usage_bytes", "Disk usage in bytes", ["type"], registry=registry)
PROCESS_UPTIME = Gauge("process_uptime_seconds", "Process uptime in seconds", registry=registry)
