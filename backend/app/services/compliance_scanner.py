...
class ComplianceScanner:
    ...
    def _load_keywords(self):
        ...
        keywords = self.db.query(AdvertisementLawKeyword).filter(
            AdvertisementLawKeyword.is_active).all()
        for kw in keywords:
            ...
            for kw in keywords:
                ...
                for match in matches:
                    ...
                    if kw["alternative"] and kw["alternative"] not in suggestions:
                        suggestions.append(
                            f"将 '{kw['keyword']}' 替换为 '{kw['alternative']}'")
    ...
    def _find_matches(self, text: str, keyword: str) -> List[Dict[str, Any]]:
        ...
        for match in re.finditer(pattern, text, re.IGNORECASE):
            ...
            matches.append({"text": match.group(), "context": context, "position": {
    ...
    def validate_content(self, title: str, content: str) -> Dict[str, Any]:
        ...
        combined_violations = title_result["violations"] + \
            content_result["violations"]
        combined_suggestions = list(
            set(title_result["suggestions"] + content_result["suggestions"]))
        ...
        return {
            ...
            "high_severity_count": title_result["high_severity_count"] +
            content_result["high_severity_count"],
            "medium_severity_count": title_result["medium_severity_count"] +
            content_result["medium_severity_count"],
            "low_severity_count": title_result["low_severity_count"] +
            content_result["low_severity_count"],
