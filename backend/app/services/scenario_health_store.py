...
SNAPSHOT_KEY = "ai_scenario_health_snapshot"
...
def load_health_snapshot(db: Session) -> dict[str, Any] | None:
...
def save_health_snapshot(db: Session, payload: dict[str, Any]) -> dict[str, Any]:
