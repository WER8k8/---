...
path = 'app/api/v1/routes/ai_learning.py'
lines = open(path, encoding='utf-8').read().split('\n')
# replace 1-indexed lines 44..150 inclusive
start, end = 44, 150
new_block = '''@router.get("/conversion-funnel")
...
print("ai_learning.py updated; new line count of file:", len(new_lines))
