...
**任务ID**: scan_20260722_085658_1541114114512
**生成时间**: 2026-07-22 08:56:59
...
- **类别**: A03:2021
- **描述**: 检测命令注入漏洞
- **匹配内容**: `ous_api = any(api in matched_content for api in ["os.system", "os.popen"])
...
- **类别**: A03:2021
- **描述**: 检测命令注入漏洞
- **匹配内容**: `(api in matched_content for api in ["os.system", "os.popen"])
